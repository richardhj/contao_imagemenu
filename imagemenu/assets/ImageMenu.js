/**************************************************************
	...
	Desc	: horizontal menu, reveals more of the image as you rollover it.
	Licence	: Open Source MIT Licence
	Requires: [Core/Fx.CSS, Core/Fx.Transitions, More/Fx.Elements]
	
	visit https://github.com/samuelbirch/ImageMenu/pull/1 for more information
	...
	initialize: function(elements, options){
		...
		this.elements.each(function(el, i){
			...
			if (self.options.openOnClick) el.addEvent('click', function(e){/*
				e.stop(); Kommentiert, da Element sonst nicht verlinkbar */
